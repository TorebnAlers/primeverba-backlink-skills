...
| NextGenTools | Exclude | The site says it manually reviews tools, but also offers paid “DO-Follow Backlink” and text-optimisation services. That is an unqualified paid-ranking-link offer. Evidence: https://nextgentools.me/submit-your-tool | Do not submit. |
| AI Tool Guru | Unavailable | The submit route returned an origin timeout during the current check. It cannot pass the availability gate. Evidence: https://aitoolguru.com/submit-ai-tool | Do not submit or retry until it is demonstrably available. |
| Neil Patel Apps & Integrations | Exclude | The historical submit URL now redirects to an Ubersuggest apps/integrations page rather than a product-directory intake. Evidence: https://aitools.neilpatel.com/submit/ | Do not submit. |
| Startup Stash | Exclude | A direct source check found that its “Add a Listing” page exposes only a newsletter subscription form, not a product-listing form. A nonfunctional route cannot pass the availability gate. Evidence: https://startupstash.com/add-listing/ | Do not submit. |
